...
context("fileInput_modular") # note that context is not encouraged for testthat >= 2.1
testthat::test_that("fileInput_modular", {
  ...
  results <- withr::with_libpaths(tmp_lib, {
    shinytest::testApp(appDir = testthat::test_path("../fileInput_modular"), compareImages = FALSE)
  }, action = "prefix")
