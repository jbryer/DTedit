...
context("selectInputReactive") # note that context is not encouraged for testthat >= 2.1
testthat::test_that("selectInputReactive", {
  ...
  results <- withr::with_libpaths(tmp_lib, {
    shinytest::testApp(appDir = testthat::test_path("../selectInputReactive"), compareImages = FALSE)
  }, action = "prefix")
