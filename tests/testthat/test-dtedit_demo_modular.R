...
context("dtedit_demo_modular") # note that context is not encouraged for testthat >= 2.1
testthat::test_that("dtedit_demo_modular", {
  ...
  results <- withr::with_libpaths(tmp_lib, {
    shinytest::testApp(appDir = testthat::test_path("../dtedit_demo_modular"), compareImages = FALSE)
  }, action = "prefix")
