...
context("datetimeInput") # note that context is not encouraged for testthat >= 2.1
testthat::test_that("datetimeInput", {
  ...
  results <- withr::with_libpaths(tmp_lib, {
    shinytest::testApp(appDir = testthat::test_path("../datetimeInput"),
                       compareImages = FALSE)
  }, action = "prefix")
