...
app$setInputs(`books-editdtdt_rows_selected` = 6, allowInputNoBinding_ = TRUE)
app$setInputs(`books-editdtdt_rows_last_clicked` = 6, allowInputNoBinding_ = TRUE)
app$setInputs(`books-editdt_copy` = "click")
app$setInputs(`books-editdt_add_Authors` = c("Chambers, J.M.", "Hastie, T.J.", "Becker, R.A.", "Wilks, A.R."),
