...
app$setInputs(`Grocery_List-editdt_add_Buy` = "Apples")
app$setInputs(`Grocery_List-editdt_add_Buy` = "Apple Cider")
Sys.sleep(2)
app$setInputs(`Grocery_List-editdt_insert` = "click")
app$setInputs(`Grocery_List-editdt_add` = "click")
app$setInputs(`Grocery_List-editdt_add_Buy` = "")
app$setInputs(`Grocery_List-editdt_add_Buy` = "Carrots")
app$setInputs(`Grocery_List-editdt_add_Quantity `= 7)
Sys.sleep(2)
app$setInputs(`Grocery_List-editdt_insert` = "click")
Sys.sleep(2)
