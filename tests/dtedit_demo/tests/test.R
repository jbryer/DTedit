...
app$setInputs(books_edit_Authors = c("Chambers, J.M.", "Becker, R.A."))
app$setInputs(books_edit_Publisher = "Wadsworth & Brooks")
app$setInputs(books_edit_Date = "1984-01-01")
app$setInputs(books_edit_Title = "S: An Interactive Environment for Data Analysis and Graphics")
app$setInputs(books_edit_Authors = c("Chambers, J.M.", "Becker, R.A.", "Hastie, T.J."))
app$setInputs(books_edit_Date = "1984-01-11")
...
app$setInputs(books_add_Title = "Things a Computer Scientist Rarely Talks About")
app$setInputs(books_add_Authors = c("Becker, R.A.", "Wilks, A.R."))
app$setInputs(books_add_Date = "2001-06-10")
...
app$setInputs(names_add_Email = "jd@jd.com")
app$setInputs(names_add_Date = "2020-06-01")
app$setInputs(names_add_Type = "User")
