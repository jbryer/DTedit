...
`inputEvent` is a named list, including a function with the name of one of the
editable columns. The function takes an `inputId` argument of the input dialog
which is related to the editable column. The function
can then access the contents of the input dialog, create
...
server <- function(input, output) {
  ...
  Grocery_List_Results <- dtedit(
    ...
    inputEvent = list(Quantity = function(x) {
